...
Microservico dedicado ao gerenciamento completo de consumidores/clientes. Controla cadastro, perfil, enderecos, cartoes de pagamento, historico de servicos, preferencias, programa de fidelidade e sistema de avaliacoes dos clientes da plataforma.

### Principais Funcionalidades

- **Perfil do Cliente**: CRUD completo de dados pessoais
- **Enderecos**: Gestao de multiplos enderecos
- **Metodos de Pagamento**: Cartoes e contas bancarias
- **Historico de Pedidos**: Acompanhamento completo
- **Avaliacoes**: Sistema de rating e reviews
- **Preferencias**: Configuracoes personalizadas
- **Programa de Fidelidade**: Pontos e recompensas
- **Dashboard**: Metricas pessoais do cliente
...
`ash
# Build da imagem
docker build -t pam_ms_consumer .
...
- **Producao**: https://api.pam.com/pam_ms_consumer/swagger
...
- **Issues**: [GitHub Issues](https://github.com/EmmanuelSMenezes/PAM_MS_Consumer/issues)
- **Wiki**: [Documentacao Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Consumer/wiki)
