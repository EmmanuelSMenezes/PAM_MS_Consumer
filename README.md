...
Microserviço dedicado ao **gerenciamento completo de consumidores/clientes**. Controla cadastro, perfil, endereços, cartões de pagamento, histórico de serviços, preferências, programa de fidelidade e sistema de avaliações dos clientes da plataforma.

### 🎯 Principais Funcionalidades

- 👤 **Perfil do Cliente**: CRUD completo de dados pessoais
- 📍 **Endereços**: Gestão de múltiplos endereços
- 💳 **Métodos de Pagamento**: Cartões e contas bancárias
...
- 📊 **Dashboard**: Métricas pessoais do cliente
...
- **Produção**: `https://api.pam.com/pam_ms_consumer/swagger`
...
- **📖 Wiki**: [Documentação Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Consumer/wiki)
...
**[⬆ Voltar ao Topo](#-PAM_MS_Consumer)**
