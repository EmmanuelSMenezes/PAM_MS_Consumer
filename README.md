...
MicroserviÃ§o dedicado ao **gerenciamento completo de consumidores/clientes**. Controla cadastro, perfil, endereÃ§os, cartÃµes de pagamento, histÃ³rico de serviÃ§os, preferÃªncias, programa de fidelidade e sistema de avaliaÃ§Ãµes dos clientes da plataforma.

### ðŸŽ¯ Principais Funcionalidades

- ðŸ‘¤ **Perfil do Cliente**: CRUD completo de dados pessoais
- ðŸ“ **EndereÃ§os**: GestÃ£o de mÃºltiplos endereÃ§os
- ðŸ’³ **MÃ©todos de Pagamento**: CartÃµes e contas bancÃ¡rias
- ðŸ“‹ **HistÃ³rico de Pedidos**: Acompanhamento completo
- â­ **AvaliaÃ§Ãµes**: Sistema de rating e reviews
- ðŸŽ¯ **PreferÃªncias**: ConfiguraÃ§Ãµes personalizadas
- ðŸ† **Programa de Fidelidade**: Pontos e recompensas
- ðŸ“Š **Dashboard**: MÃ©tricas pessoais do cliente
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Consumer;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
`
...
az webapp deploy --resource-group PAM --name PAM_MS_Consumer --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Consumer.ToLower() registry.azurecr.io/pam/PAM_MS_Consumer.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Consumer.ToLower():latest
`
...
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Consumer/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_MS_Consumer)**
